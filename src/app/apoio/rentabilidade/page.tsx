...
export default function RentabilidadeForm() {
    ...
    return (
        <main className="min-h-screen flex items-center text-black justify-center bg-gray-50 p-4">

            <div className="bg-white p-6 rounded-xl shadow-md w-full max-w-md">
                <a className="text-sm text-blue-800 mb-4 text-center" href="/apoio">voltar</a>
